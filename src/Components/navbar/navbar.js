    ...
    <>
      <div className={navbarClasses.join(" ")}>
        ...
        <nav className="navigation">
          ...
          <li>
            <p>
              <Link to="/">Vehicle</Link>&thinsp;&thinsp;
            </p>
          </li>
          <li>
            <p>
        ...
        <nav className="Subnavigation">
          <li>
            <p>
              <Link to="/">หน้าหลัก</Link>&emsp;&thinsp;
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <Link to="/myticket">ประวัติการจอง</Link>&emsp;&emsp;
            </p>
          </li>
        </nav>
      ...
      {SignupPopup && (
        <>
          ...
          <div className="signup">
            <div className="box2">
              <span className="close" onClick={toggleSignup}>
                x
              </span>
      ...
      {LoginPopup && (
        <>
          ...
          <div className="containerr">
            ...
            <div className="login">
              <span className="close" onClick={toggleLogin} align="right">
                x
              </span>
